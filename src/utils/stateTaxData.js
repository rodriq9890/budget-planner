// 2025/2026 State Income Tax Data
...
// States with PROGRESSIVE brackets (single filer)
const PROGRESSIVE_STATES = {
  ...
  CA: [
    ...
    { min: 72724, max: 372984, rate: 0.093 },
    { min: 372984, max: 447582, rate: 0.103 },
    { min: 447582, max: 745968, rate: 0.113 },
    { min: 745968, max: 1000000, rate: 0.123 },
  ...
  KS: [
    ...
    { min: 15000, max: Infinity, rate: 0.057 },
  ],
  ME: [
  ...
  ND: [
    { min: 0, max: 51650, rate: 0.0195 },
    { min: 51650, max: Infinity, rate: 0.025 },
  ],
  OK: [
    { min: 0, max: 7200, rate: 0.025 },
    { min: 7200, max: 12600, rate: 0.035 },
    { min: 12600, max: Infinity, rate: 0.045 },
  ],
  OR: [
  ...
  SC: [
    ...
    { min: 17330, max: Infinity, rate: 0.06 },
  ],
  VT: [
    { min: 0, max: 45400, rate: 0.0355 },
...
const CITY_TAXES = {
  ...
  "Yonkers": {
    ...
    surchargeType: "percent_of_state",
  },
  "Detroit": {
    state: "MI",
    flatRate: 0.024,
...
const ZIP_TO_STATE = {
  ...
  "170":"PA","171":"PA","172":"PA","173":"PA","174":"PA","175":"PA","176":"PA",
  "177":"PA","178":"PA","179":"PA","180":"PA","181":"PA","182":"PA","183":"PA","184":"PA","185":"PA","186":"PA",
  "187":"PA","188":"PA","189":"PA","190":"PA","191":"PA","192":"PA","193":"PA","194":"PA","195":"PA","196":"PA",
  ...
  "380":"TN","381":"TN","382":"TN","383":"TN","384":"TN","385":"TN","386":"MS",
  "387":"MS","388":"MS","389":"MS","390":"MS","391":"MS","392":"MS","393":"MS","394":"MS","395":"MS","396":"MS","397":"MS",
...
// NYC zip code prefixes (first 3 digits for the 5 boroughs)
const NYC_ZIP_PREFIXES = [
  "100","101","102","103","104","105","106","107","108","109",
  "110","111","112","113","114","116",
]

// Yonkers zip prefixes
const YONKERS_ZIP_PREFIXES = ["107"]
...
export function getStateFromZip(zip) {
  ...
  // Check for city taxes
  let city = null
  if (stateCode === "NY") {
    if (NYC_ZIP_PREFIXES.includes(prefix)) city = "New York City"
    if (YONKERS_ZIP_PREFIXES.includes(prefix)) city = "Yonkers"
  }

  return { stateCode, stateName: STATE_NAMES[stateCode], city }
}

export function getStateBrackets(stateCode) {
  if (!stateCode) return null
  if (NO_TAX_STATES.includes(stateCode)) return { type: "none" }
  if (FLAT_TAX_STATES[stateCode]) return { type: "flat", rate: FLAT_TAX_STATES[stateCode] }
  if (PROGRESSIVE_STATES[stateCode]) return { type: "progressive", brackets: PROGRESSIVE_STATES[stateCode] }
  return null
}

export function getCityTax(cityName) {
  if (!cityName) return null
  return CITY_TAXES[cityName] || null
}
...
export function getAllStates() {
  return Object.entries(STATE_NAMES)
    ...
    .map(([code, name]) => {
      ...
      return { code, name, noTax: isNoTax }
    })
}

export function getCitiesForState(stateCode) {
  return Object.entries(CITY_TAXES)
